...
export const OPENAI_REALTIME_TOOLS: OpenAIRealtimeTool[] = [
  {
    type: "function",
    name: "doom_get_state",
    description:
      "Get complete game state: health, armor, ammo, weapons, keys, position, " +
  ...
  },
  {
    ...
    description:
      "Get a concise summary of your current situation: health, weapon, " +
  ...
  },
  {
    ...
    description:
      "Get a natural language description of your surroundings. " +
  ...
  },
  {
    ...
    description:
      "Execute an action: forward, backward, strafe-left, strafe-right, " +
