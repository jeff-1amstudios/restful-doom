...
async function connect(url) {
    ...
    try {
        ...
        client.setRequestHandler(ElicitRequestSchema, async (request) => {
            ...
            console.log(`Related Task: ${(_b = (_a = request.params._meta) === null || _a === void 0 ? void 0 : _a[RELATED_TASK_META_KEY]) === null || _b === void 0 ? void 0 : _b.taskId}`);
            ...
            while (attempts < maxAttempts) {
                ...
                if (!isValid) {
                    ...
                    (_c = validate.errors) === null || _c === void 0 ? void 0 : _c.forEach(error => {
