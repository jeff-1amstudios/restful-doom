...
const TOOLS = [
    {
        name: "doom_get_state",
        description: "Get the complete game state including player stats (health, armor, ammo, weapons, keys), " +
    ...
    },
    {
        ...
        description: "Get a concise observation suitable for AI context. Returns player status, " +
    ...
    },
    {
        ...
        description: "Get a natural language description of the current environment. " +
    ...
    },
    {
        ...
        description: "Execute a player action in the game. Available actions: " +
        ...
        inputSchema: {
            ...
            properties: {
                ...
                amount: {
                    type: "number",
                    description: "Optional amount: movement distance (1-50), turn degrees, or weapon number (1-8)",
                },
            },
            required: ["action"],
        },
    ...
    {
        name: "doom_turn_to",
        description: "Turn to face a specific absolute angle. " +
    ...
    },
    {
        ...
        description: "Turn to face a specific object by its ID. " +
    ...
    {
        name: "doom_can_see",
        description: "Check if you have line of sight to a specific object by ID. " +
    ...
    },
    {
        ...
        description: "Display a message on the player's HUD (heads-up display). " +
    ...
    },
    {
        ...
        description: "Get simulated audio cues based on nearby enemies. " +
    ...
    {
        name: "doom_raycast",
        description: "Cast a ray to detect wall distance in a specific direction. " +
        ...
        inputSchema: {
            ...
            properties: {
                angle: {
                    ...
                    minimum: 0,
                    maximum: 359,
                    description: "Direction to cast ray in degrees (0-359). If not specified, uses player's facing direction. " +
                        "0=East, 90=North, 180=West, 270=South.",
                },
            },
            required: [],
    ...
    },
    {
        ...
        description: "Get wall distances in all four cardinal directions relative to player facing. " +
...
async function main() {
    ...
    if (!connected) {
        console.error("[doom-bridge] WARNING: Cannot connect to restful-doom. " +
            ...
            switch (name) {
                ...
                case "doom_can_see": {
                    ...
                    if (objectId === undefined) {
                        return {
                            content: [
                                { type: "text", text: "Error: objectId is required" },
                            ],
                            isError: true,
                        };
                    }
